...
class OptionsChain(BaseModel):
    ...
    # Metadata
    chain_timestamp: Optional[datetime] = Field(None, description="Chain retrieval timestamp")
    ...
    def get_contracts_by_expiration(self, expiration: date) -> List[OptionContract]:
        ...
        return [
            contract for contract in (self.calls + self.puts)
    ...
    def get_atm_contracts(self, tolerance: Decimal = Decimal('0.05')) -> List[OptionContract]:
