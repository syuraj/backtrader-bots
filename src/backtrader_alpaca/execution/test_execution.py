...
class TestBacktestRunner:
    ...
    def test_run_backtest_with_local_data(self, mock_pandas_data, mock_cerebro, backtest_runner, mock_strategy):
    ...
    def test_run_backtest_with_alpaca_data(self, mock_client, mock_cerebro, backtest_runner, mock_strategy):
...
class TestLiveRunner:
    ...
    def test_run_live_trading(self, live_runner, mock_strategy):
        ...
        result = live_runner.run_live_trading(
            strategy=mock_strategy,
            symbol="AAPL"
        )
