...
class TestOptionsClient:
    ...
    def test_options_api_error_handling(self, options_client):
        ...
        options_client.get_options_chain = Mock(side_effect=Exception("Options API Error"))
    ...
    def test_rate_limiting(self, options_client):
        ...
        options_client.get_options_chain = Mock(side_effect=HTTPError(response=mock_response))
